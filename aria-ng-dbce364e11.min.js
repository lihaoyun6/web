...
function() {
    ...
    if (e) {
        ...
        t.className = "alert alert-danger",
        t.innerHTML = "Sorry, AriaNg cannot support this browser, please upgrade your browser!",
        document.getElementById("content-wrapper").appendChild(t)
    }
} (),
function() {
    "use strict";
...
function() {
    "use strict";
    angular.module("ariaNg").config(["$routeProvider",
    function(e) {
        e.when("/downloading", {
        ...
        }).when("/moretools/baidu/1", {
            templateUrl: "views/baidu1.html",
        }).when("/moretools/baidu/2", {
            templateUrl: "views/baidu2.html",
        }).when("/moretools/baidu/3", {
            templateUrl: "views/baidu3.html",
        }).when("/dht", {
            templateUrl: "views/dht.html",
		}).when("/speedtest", {
...
function() {
    "use strict";
    angular.module("ariaNg").run(["$rootScope", "$location", "$document", "SweetAlert", "ariaNgNotificationService", "ariaNgSettingService", "aria2TaskService",
    function(e, t, a, n, i, s, o) {
        ...
        e.swipeActions = {
            leftSwipe: function() {
                return p() ? void u() : void((!this.extentLeftSwipe || angular.isFunction(this.extentLeftSwipe) && !this.extentLeftSwipe()) && u())
            },
            rightSwipe: function() { (!this.extentRightSwipe || angular.isFunction(this.extentRightSwipe) && !this.extentRightSwipe()) && d()
            }
        },
...
function() {
    "use strict";
    angular.module("ariaNg").config(["$translateProvider", "localStorageServiceProvider", "NotificationProvider", "ariaNgConstants",
    function(e, t, a, n) {
...
function() {
    ...
    angular.module("ariaNg").constant("ariaNgFileTypes", {
        video: [".3gp", ".3gpp", ".asf", ".asx", ".avi", ".dat", ".flv", ".m4v", ".mkv", ".mov", ".mp4", ".mpe", ".mpeg", ".mpg", ".rm", ".rmvb", ".vob", ".wmv"],
        audio: [".aac", ".amr", ".ape", ".flac", ".m4a", ".mid", ".mp3", ".ogg", ".ra", ".vqf", ".wav", ".wma"],
        picture: [".bmp", ".emf", ".gif", ".jp2", ".jpeg", ".jpg", ".png", ".psd", ".raw", ".tga", ".tif", ".tiff", ".wmf"],
        document: [".doc", ".docx", ".key", ".numbers", ".odp", ".ods", ".odt", ".pages", ".pdf", ".ppt", ".pptx", ".rtf", ".txt", ".vsd", ".vsdx", ".wps", ".xls", ".xlsx"],
        application: [".apk", ".bat", ".com", ".deb", ".dll", ".dmg", ".exe", ".ipa", ".jar", ".rpm", ".sh"],
        archive: [".7z", ".arj", ".bz2", ".cab", ".gz", ".iso", ".r", ".rar", ".tar", ".tar", ".z", ".zip"]
    })
} (),
function() {
    "use strict";
    angular.module("ariaNg").run(["amMoment", "moment", "ariaNgSettingService",
    function(e, t, a) {
        var n = a.getLanguage();
...
function() {
    "use strict";
    angular.module("ariaNg").config(["$translateProvider", "ariaNgConstants",
    function(e, t) {
        var a = {
            ...
            Settings: "Settings",
            "Aria2down Settings": "Aria2down Settings",
            ...
            "Aria2down Title": "Aria2down Title",
...
function() {
    "use strict";
    angular.module("ariaNg").controller("CommandController", ["$rootScope", "$location", "$routeParams", "base64", "ariaNgCommonService", "aria2TaskService",
    function(e, t, a, n, i, s) {
        ...
        if (0 === o.indexOf("/new/")) {
            ...
            c = n.urldecode(l);
            e.loadPromise = r(c)
        } else i.error("Parameter is invalid!")
    }])
} (),
function() {
    "use strict";
    angular.module("ariaNg").controller("MainController", ["$rootScope", "$scope", "$route", "$location", "$document", "$interval", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgNotificationService", "aria2TaskService", "aria2SettingService",
    function(e, t, a, n, i, s, o, r, l, c, d, u, p) {
        var f = null,
        g = null,
        m = function() {
            var e = function(e) {
                return e ? {
                    downloadingCount: e.numActive,
                    waitingCount: e.numWaiting,
                    stoppedCount: e.numStopped,
                    downloadSpeed: e.downloadSpeed,
                    uploadSpeed: e.uploadSpeed
                }: null
            } (t.globalStat);
            i[0].title = l.getFinalTitle(e)
        },
        h = function(e, a) {
            return p.getGlobalStat(function(e) {
                return e.success || e.data.message !== o.Unauthorized.message ? (e.success && (t.globalStat = e.data, c.recordGlobalStat(e.data)), void(a && a(e))) : void s.cancel(g)
            },
            e)
        };
        l.getBrowserNotification() && d.requestBrowserPermission(),
        t.globalStatusContext = {
            data: c.getGlobalStatsData()
        },
        ...
        t.isSpecifiedTaskSelected = function() {
            ...
            for (var a = 0; a < t.length; a++) for (var n = 0; n < arguments.length; n++) if (t[a].status === arguments[n]) return ! 0;
            return ! 1
        },
        ...
        t.changeTasksState = function(t) {
            var i = e.taskContext.getSelectedTaskIds();
            if (i && !(i.length < 1)) {
                var s = null;
                if ("start" === t) s = u.startTasks;
                else {
                    if ("pause" !== t) return;
                    s = u.pauseTasks
                }
                e.loadPromise = s(i,
                function(e) {
                    e.hasError && i.length > 1 && r.showError("Failed to change some tasks state."),
                    e.hasSuccess && (h(!0), e.hasError || "start" !== t ? e.hasError || "pause" !== t || ("/downloading" === n.path() ? n.path("/waiting") : a.reload()) : "/waiting" === n.path() ? n.path("/downloading") : a.reload())
                },
                i.length > 1)
            }
        },
        t.removeTasks = function() {
            var t = e.taskContext.getSelectedTasks(); ! t || t.length < 1 || r.confirm("Confirm Remove", "Are you sure you want to remove the selected task?", "warning",
            function() {
                e.loadPromise = u.removeTasks(t,
                function(e) {
                    e.hasError && t.length > 1 && r.showError("Failed to remove some task(s)."),
                    e.hasSuccess && (h(!0), e.hasError || ("/stopped" === n.path() ? a.reload() : n.path("/stopped")))
                },
                t.length > 1)
            })
        },
        t.clearStoppedTasks = function() {
            r.confirm("Confirm Clear", "Are you sure you want to clear stopped tasks?", "warning",
            function() {
                e.loadPromise = u.clearStoppedTasks(function(e) {
                    e.success && (h(!0), "/stopped" === n.path() ? a.reload() : n.path("/stopped"))
                })
            })
        },
        ...
        t.changeDisplayOrder = function(e, t) {
            var a = r.parseOrderType(l.getDisplayOrder()),
            n = r.parseOrderType(e);
            t && n.type === a.type && (n.reverse = !a.reverse),
            l.setDisplayOrder(n.getValue())
        },
        t.isSetDisplayOrder = function(e) {
            var t = r.parseOrderType(l.getDisplayOrder()),
            a = r.parseOrderType(e);
            return t.equals(a)
        },
        l.getTitleRefreshInterval() > 0 && (f = s(function() {
            m()
        },
        l.getTitleRefreshInterval())),
        l.getGlobalStatRefreshInterval() > 0 && (g = s(function() {
            h(!0)
        },
        l.getGlobalStatRefreshInterval())),
        t.$on("$destroy",
        function() {
            f && s.cancel(f),
            g && s.cancel(g)
...
function() {
    "use strict";
    angular.module("ariaNg").controller("NewTaskController", ["$rootScope", "$scope", "$location", "$timeout", "aria2SettingService", "aria2TaskService", "ariaNgFileService",
    function(e, t, a, n, i, s, o) {
        var r = ["links", "options"];
        t.context = {
            currentTab: "links",
            ...
            availableOptions: function() {
                var e = i.getNewTaskOptionKeys();
                return i.getSpecifiedOptions(e)
            } (),
            globalOptions: null,
            options: {}
        },
        ...
        e.swipeActions.extentLeftSwipe = function() {
            var e = r.indexOf(t.context.currentTab);
            return e < r.length - 1 && (t.changeTab(r[e + 1]), !0)
        },
        e.swipeActions.extentRightSwipe = function() {
            var e = r.indexOf(t.context.currentTab);
            return e > 0 && (t.changeTab(r[e - 1]), !0)
        },
        t.loadDefaultOption = function() {
            t.context.globalOptions || (e.loadPromise = i.getGlobalOption(function(e) {
                e.success && (t.context.globalOptions = e.data)
            }))
        },
        t.openTorrent = function() {
            o.openFileContent(".torrent",
            function(n) {
                var i = {
                    content: n.base64Content,
                    options: angular.copy(t.context.options)
                };
                e.loadPromise = s.newTorrentTask(i, !0,
                function(e) {
                    e.success && a.path("/task/detail/" + e.data)
                })
            })
        },
        t.openMetalink = function() {
            o.openFileContent(".meta4,.metalink",
            function(n) {
                var i = {
                    content: n.base64Content,
                    options: angular.copy(t.context.options)
                };
                e.loadPromise = s.newMetalinkTask(i, !0,
                function(e) {
                    e.success && a.path("/task/detail/" + e.data)
                })
            })
        ...
        t.startDownload = function(n) {
            for (var i = t.context.urls.split("\n"), o = angular.copy(t.context.options), r = [], l = 0; l < i.length; l++)"" !== i[l] && "" !== i[l].trim() && r.push({
                urls: [i[l].trim()],
                options: o
            });
            e.loadPromise = s.newUriTasks(r, n,
            function(e) {
                e.hasSuccess && (n ? a.path("/waiting") : a.path("/downloading"))
            })
        },
...
function() {
    "use strict";
    angular.module("ariaNg").controller("DownloadListController", ["$rootScope", "$scope", "$window", "$location", "$route", "$interval", "dragulaService", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "aria2TaskService",
    function(e, t, a, n, i, s, o, r, l, c, d) {
        ...
        g = !0,
        m = function(t) {
            if (!f) return d.getTaskList(u, g,
            function(t) {
                if (!f) {
                    if (!t.success) return void(t.data.message === r.Unauthorized.message && s.cancel(p));
                    ...
                    if (a ? (e.taskContext.list = n, g = !1) : g = !l.extendArray(n, e.taskContext.list, "gid"), e.taskContext.list && e.taskContext.list.length > 0 && (d.processDownloadTasks(e.taskContext.list), !a)) {
                        for (var i = !1,
                        o = 0; o < e.taskContext.list.length; o++) {
                        ...
                        if (!i) return g = !0,
                        void(e.taskContext.list.length = 0)
                    }
        ...
        t.$on("task-list.drop-model",
        function(e, t, a) {
            var n = angular.element(t),
            i = n.attr("data-gid"),
            s = n.index();
            f = !0,
            d.changeTaskPosition(i, s,
            function() {
                f = !1
            },
            !0)
...
function() {
    "use strict";
    angular.module("ariaNg").controller("TaskDetailController", ["$rootScope", "$scope", "$routeParams", "$interval", "aria2RpcErrors", "ariaNgFileTypes", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "aria2TaskService", "aria2SettingService",
    function(e, t, a, n, i, s, o, r, l, c, d) {
        ...
        g = function(e, t) {
            ...
            if (a) return d.getSpecifiedOptions(a)
        },
        m = function(a) {
            a && ("active" === a.status && a.bittorrent || u.indexOf("btpeers") >= 0 && u.splice(u.indexOf("btpeers"), 1), t.task && t.task.status === a.status || (t.context.availableOptions = g(a.status, !!a.bittorrent)), t.task = o.copyObjectTo(a, t.task), e.taskContext.list = [t.task], e.taskContext.selected = {},
            e.taskContext.selected[t.task.gid] = !0, l.recordStat(a.gid, a))
        },
        h = function(e) {
        ...
        y = function(e) {
            if (!f) {
                var s = function(e) {
                    e === i.Unauthorized.message && n.cancel(p)
                },
                o = !0;
                return t.task ? c.getTaskStatusAndBtPeers(a.gid,
                function(e) {
                    return e.success ? (m(e.task), void h(e.peers)) : s(e.data.message)
                },
                e, v(t.task), o) : c.getTaskStatus(a.gid,
                function(t) {
                    if (!t.success) return s(t.data.message);
                    var a = t.data;
                    m(a),
                    v(a) && c.getBtTaskPeers(a,
                    function(e) {
                        e.success && h(e.data)
                    },
                    e, o)
        ...
        b = function(e) {
            if (t.task && t.task.files) {
                for (var a = t.task.gid,
                n = [], i = 0; i < t.task.files.length; i++) {
                    var s = t.task.files[i];
                    s && s.selected && n.push(s.index)
                }
                return f = !0,
                c.selectTaskFile(a, n,
                function(e) {
                    f = !1,
                    e.success && y(!1)
                },
        ...
        t.getSelectedFileCount = function() {
            for (var e = 0,
            a = 0; a < t.task.files.length; a++) e += t.task.files[a].selected ? 1 : 0;
            return e
        },
        t.selectFiles = function(e) {
            if (t.task && t.task.files) for (var a = 0; a < t.task.files.length; a++)"all" === e ? t.task.files[a].selected = !0 : "none" === e ? t.task.files[a].selected = !1 : "reverse" === e && (t.task.files[a].selected = !t.task.files[a].selected)
        },
        ...
        t.saveChoosedFiles = function() {
            t.context.showChooseFilesToolbar && (e.loadPromise = b(!1), t.context.showChooseFilesToolbar = !1)
        },
        t.cancelChooseFiles = function() {
            t.context.showChooseFilesToolbar && (f = !1, y(!0), t.context.showChooseFilesToolbar = !1)
        },
        t.setSelectedFile = function() {
            t.context.showChooseFilesToolbar || b(!0)
        },
        ...
        t.loadTaskOption = function(a) {
            e.loadPromise = c.getTaskOptions(a.gid,
            function(e) {
                e.success && (t.context.options = e.data)
            })
        },
        t.setOption = function(e, a, n) {
            return c.setTaskOption(t.task.gid, e, a,
            function(e) {
        ...
        r.getDownloadTaskRefreshInterval() > 0 && (p = n(function() {
            return ! t.task || "complete" !== t.task.status && "error" !== t.task.status && "removed" !== t.task.status ? void y(!0) : void n.cancel(p)
        },
...
function() {
    "use strict";
    angular.module("ariaNg").controller("AriaNgSettingsController", ["$rootScope", "$scope", "$routeParams", "$timeout", "ariaNgLanguages", "ariaNgCommonService", "ariaNgSettingService", "ariaNgNotificationService",
    function(e, t, a, n, i, s, o, r) {
        ...
        t.context = {
            currentTab: "global",
            languages: i,
            availableTime: s.getTimeOptions([1e3, 2e3, 3e3, 5e3, 1e4, 3e4, 6e4], !0),
            trueFalseOptions: [{
                name: "True",
                value: !0
            },
            ...
            settings: o.getAllOptions(),
            sessionSettings: o.getAllSessionOptions()
        },
        t.context.showDebugMode = t.context.sessionSettings.debugMode || "debug" === c,
        t.changeTab = function(e) {
            t.context.currentTab = e
        },
        e.swipeActions.extentLeftSwipe = function() {
            var e = l.indexOf(t.context.currentTab);
            return e < l.length - 1 && (t.changeTab(l[e + 1]), !0)
        },
        e.swipeActions.extentRightSwipe = function() {
            var e = l.indexOf(t.context.currentTab);
            return e > 0 && (t.changeTab(l[e - 1]), !0)
        },
        t.settingService = o,
        t.isSupportNotification = function() {
            return r.isSupportBrowserNotification() && o.isUseWebSocket(t.context.settings.protocol)
        },
        t.setEnableBrowserNotification = function(e) {
            o.setBrowserNotification(e),
            e && !r.hasBrowserPermission() && r.requestBrowserPermission(function(e) {
                r.isPermissionGranted(e) || (t.context.settings.browserNotification = !1, s.showError("You have disabled notification in your browser. You should change your browser's settings before you enable this function."))
            })
        },
...
function() {
    "use strict";
    angular.module("ariaNg").controller("Aria2SettingsController", ["$rootScope", "$scope", "$location", "ariaNgConstants", "ariaNgCommonService", "aria2SettingService",
    function(e, t, a, n, i, s) {
...
function() {
    "use strict";
    angular.module("ariaNg").controller("Aria2StatusController", ["$rootScope", "$scope", "ariaNgCommonService", "ariaNgSettingService", "aria2SettingService",
    function(e, t, a, n, i) {
        t.context = {
            host: n.getJsonRpcUrl(),
            status: "Connecting",
            serverStatus: null
        },
        ...
        t.shutdown = function() {
            a.confirm("Confirm Shutdown", "Are you sure you want to shutdown aria2?", "warning",
            function(e) {
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngAutoFocus", ["$timeout",
    function(e) {
        return {
            restrict: "A",
            link: function(t, a) {
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngPieceBar", ["aria2TaskService",
    function(e) {
        return {
            restrict: "E",
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngPieceMap", ["aria2TaskService",
    function(e) {
        return {
            restrict: "E",
            ...
            link: function(t, a) {
                ...
                o = function() {
                    ...
                    if (!i || !a || i.length !== a.length || a.length !== n.length) return void s();
                    for (var o = 0; o < n.length; o++) i[o] !== a[o] && (a[o] ? n[o].addClass("piece-completed") : n[o].removeClass("piece-completed"));
                    i = a
                };
                t.$watch("bitField",
                function() {
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngChart", ["$window", "chartTheme",
    function(e, t) {
        return {
            restrict: "E",
            template: "<div></div>",
    ...
    }]).directive("ngPopChart", ["$window", "chartTheme",
    function(e, t) {
        return {
            restrict: "A",
            scope: {
    ...
    }]).factory("chartTheme", ["chartDefaultTheme",
    function(e) {
        var t = {
            defaultTheme: e
        };
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngPlaceholder",
    function() {
        return {
            restrict: "A",
            scope: {
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngSetting", ["$timeout", "$translate", "ariaNgConstants",
    function(e, t, a) {
        return {
            restrict: "E",
            ...
            link: function(n, i, s, o) {
                ...
                n.changeValue = function(t, a) {
                    if (r && e.cancel(r), n.optionValue = t, n.optionStatus.setReady(), n.option && n.option.key && !n.option.readonly) {
                        if (n.option.required && "" === t) return void n.optionStatus.setError("Option value cannot be empty!");
                        if ("integer" === n.option.type && !/^-?\d+$/.test(t)) return void n.optionStatus.setError("Input number is invalid!");
                        if ("float" === n.option.type && !/^-?(\d*\.)?\d+$/.test(t)) return void n.optionStatus.setError("Input number is invalid!");
                        if (("integer" === n.option.type || "float" === n.option.type) && (angular.isDefined(n.option.min) || angular.isDefined(n.option.max))) {
                            var i = t;
                            if ("integer" === n.option.type ? i = parseInt(t) : "float" === n.option.type && (i = parseFloat(t)), angular.isDefined(n.option.min) && i < n.option.min) return void n.optionStatus.setError("Input number is below min value!", {
                                value: n.option.min
                            });
                            if (angular.isDefined(n.option.max) && i > n.option.max) return void n.optionStatus.setError("Input number is above max value!", {
                                value: n.option.max
                            })
                        }
                        if (angular.isDefined(n.option.pattern) && !new RegExp(n.option.pattern).test(t)) return void n.optionStatus.setError("Input value is invalid!");
                        var s = {
                            key: n.option.key,
                            value: t,
                ...
                n.$watch("defaultValue",
                function(e) {
                    var t = e;
                    if (n.option && n.option.options) for (var a = 0; a < n.option.options.length; a++) {
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngTooltip",
    function() {
        return {
            restrict: "A",
            scope: {
            ...
            link: function(e, t, a) {
                ...
                angular.extend(n, a);
                var i = n.ngTooltipIf === !0 || "true" === n.ngTooltipIf,
                s = function() {
                ...
                e.$watch("ngTooltipIf",
                function(e) {
                    angular.isUndefined(e) || (e = e === !0 || "true" === e, i !== e && (e ? s() : r(), i = e))
                })
            }
        }
    })
...
function() {
    "use strict";
    angular.module("ariaNg").filter("dateDuration", ["moment",
    function(e) {
        return function(t, a, n) {
            var i = e.duration(t, a),
            s = e.utc(i.asMilliseconds());
            return s.format(n)
        }
    }])
} (),
...
function() {
    "use strict";
    angular.module("ariaNg").filter("longDate", ["$translate", "moment",
    function(e, t) {
        return function(a) {
...
function() {
    "use strict";
    angular.module("ariaNg").filter("percent", ["$filter",
    function(e) {
        return function(t, a) {
            var n = Math.pow(10, a),
            i = parseInt(t * n) / n;
...
function() {
    "use strict";
    angular.module("ariaNg").filter("taskStatus",
    function() {
        return function(e) {
            return e ? "active" === e.status ? e.seeder === !0 || "true" === e.seeder ? "Seeding": "Downloading": "waiting" === e.status ? "Waiting": "paused" === e.status ? "Paused": "complete" === e.status ? "Completed": "error" === e.status ? e.errorCode ? "format.task.error-occurred": "Error Occurred": "removed" === e.status ? "Removed": "": ""
        }
    })
} (),
function() {
    "use strict";
    angular.module("ariaNg").filter("readableVolumn", ["$filter",
    function(e) {
        var t = ["B", "KB", "MB", "GB"],
        a = 2;
        return function(n, i) {
            var s = t[0];
            angular.isUndefined(i) && (i = a),
            n || (n = 0),
            angular.isNumber(n) || (n = parseInt(n));
            for (var o = 1; o < t.length && n >= 1024; o++) n /= 1024,
            s = t[o];
            return n = e("number")(n, i),
            n + " " + s
        }
    }])
} (),
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgCommonService", ["$location", "$timeout", "base64", "SweetAlert", "$translate", "ariaNgConstants",
    function(e, t, a, n, i, s) {
        return {
            ...
            confirm: function(e, t, a, s, o) {
                ...
                "warning" === a && (r.confirmButtonColor = "#F39C12"),
                n.swal(r,
                function(e) {
                    e && s && s()
                })
            ...
            pushArrayTo: function(e, t) {
                if (angular.isArray(e) || (e = []), !angular.isArray(t) || t.length < 1) return e;
                for (var a = 0; a < t.length; a++) e.push(t[a]);
                return e
            },
            combineArray: function() {
                for (var e = [], t = 0; t < arguments.length; t++) angular.isArray(arguments[t]) ? this.pushArrayTo(e, arguments[t]) : e.push(arguments[t]);
                return e
            },
            countArray: function(e, t) {
                if (!angular.isArray(e) || e.length < 1) return 0;
                for (var a = 0,
                n = 0; n < e.length; n++) a += e[n] === t ? 1 : 0;
                return a
            },
            ...
            getTimeOptions: function(e, t) {
                ...
                if (t && a.push({
                    ...
                    value: 0,
                    optionValue: 0
                }), !angular.isArray(e) || e.length < 1) return a;
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgFileService", ["$window", "ariaNgCommonService",
    function(e, t) {
        var a = !!e.FileReader,
        n = function(e) {
            var t = [];
            if (!e || e.length < 1) return t.push(/.+$/),
            t;
        ...
        i = function(e, t) {
            ...
            for (var a = 0; a < t.length; a++) if (t[a].test(e)) return ! 0;
            return ! 1
        };
        return {
            openFileContent: function(e, s) {
                if (!a) return void t.showError("Your browser does not support loading file!");
                var o = n(e);
                angular.element('<input type="file" style="display: none"/>').change(function() {
                    if (this.files && !(this.files.length < 1)) {
                        var e = this.files[0],
                        a = e.name;
                        if (!i(a, o)) return void t.showError("The selected file type is invalid!");
                        ...
                        n.onerror = function() {
                            t.showError("Failed to load file!")
                        },
                        n.readAsDataURL(e)
                    }
                }).trigger("click")
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLanguageLoader", ["$http", "$q", "localStorageService", "ariaNgConstants", "ariaNgLanguages",
    function(e, t, a, n, i) {
        var s = function(e) {
            var t = e.indexOf("=");
            return t > 0 ? {
                key: e.substring(0, t),
                value: e.substring(t + 1, e.length)
            }: {
                value: e
            }
        },
        o = function(e, t) {
            var a = e;
            if (!t) return a;
            if ("[" === t[0] && "]" === t[t.length - 1] && (t = t.substring(1, t.length - 1)), "default" === t) return a;
        ...
        return function(s) {
            var o = t.defer();
            if (!i[s.key]) return o.reject(s.key),
            o.promise;
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgMonitorService", ["$filter", "$translate", "moment", "ariaNgConstants",
    function(e, t, a, n) {
        var i = {},
        s = "global",
        o = function(e) {
            return e === s ? n.globalStatStorageCapacity: n.taskStatStorageCapacity
        },
        r = function(n) {
            for (var s = {
                legend: {
                ...
                tooltip: {
                    ...
                    formatter: function(n) {
                        if ("" === n[0].name) return "<div>" + t.instant("No Data") + "</div>";
                        var i = a(n[0].name, "X").format("HH:mm:ss"),
                        s = e("readableVolumn")(n[0].value) + "/s",
                        o = e("readableVolumn")(n[1].value) + "/s";
                        return "<div>" + i + '</div><div><i class="icon-download fa fa-arrow-down"></i> ' + o + '</div><div><i class="icon-upload fa fa-arrow-up"></i> ' + s + "</div>"
                    }
                },
                xAxis: {
                    data: [],
            ...
            r = s.xAxis.data, l = s.series[0].data, c = s.series[1].data, d = 0; d < o(n); d++) r.push(""),
            l.push(""),
            c.push("");
            return i[n] = s,
            s
        ...
        c = function(e, t) {
            ...
            s = a.series[0].data,
            r = a.series[1].data;
            n.length >= o(e) && (n.shift(), s.shift(), r.shift()),
            n.push(t.time),
            s.push(t.uploadSpeed),
        ...
        return {
            ...
            recordGlobalStat: function(e) {
                return this.recordStat(s, e)
            },
            getGlobalStatsData: function() {
                return this.getStatsData(s)
            }
        }
    }])
} (),
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgNotificationService", ["$notification", "$translate", "Notification", "ariaNgSettingService",
    function(e, t, a, n) {
        var i = e.isSupported,
        s = function(e) {
            return "granted" === e
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgSettingService", ["$window", "$location", "$filter", "$translate", "base64", "amMoment", "localStorageService", "ariaNgConstants", "ariaNgDefaultOptions", "ariaNgLanguages",
    function(e, t, a, n, i, s, o, r, l, c) {
        var d = [],
        u = {
            debugMode: !1
        },
        p = function() {
            if (angular.isArray(d) && !(d.length < 1)) for (var e = 0; e < d.length; e++) {
                var t = d[e];
                t()
            }
        },
        ...
        h = function() {
            ...
            return e || (e = angular.extend({},
            l), e.language = f(), m(e), p()),
            e
        },
        v = function(e) {
            var t = h();
            return angular.isUndefined(t[e]) && (t[e] = l[e], m(t)),
            t[e]
        },
        y = function(e, t) {
            var a = h();
        ...
        return {
            getAllOptions: function() {
                ...
                l, h());
                return e.rpcHost || (e.rpcHost = g()),
                e.secret && (e.secret = i.decode(e.secret)),
                e
            },
            ...
            getFinalTitle: function(e) {
                ...
                e),
                t = t.replace(/\$\{downloading\}/g, n.instant("Downloading") + ": " + e.downloadingCount),
                t = t.replace(/\$\{waiting\}/g, n.instant("Waiting") + ": " + e.waitingCount),
                t = t.replace(/\$\{stopped\}/g, n.instant("Downloaded / Stopped") + ": " + e.stoppedCount),
                t = t.replace(/\$\{downspeed\}/g, n.instant("Download") + ": " + a("readableVolumn")(e.downloadSpeed) + "/s"),
                t = t.replace(/\$\{upspeed\}/g, n.instant("Upload") + ": " + a("readableVolumn")(e.uploadSpeed) + "/s"),
                t = t.replace(/\$\{title\}/g, r.title)
            },
            setTitle: function(e) {
                y("title", e)
            },
            getTitleRefreshInterval: function() {
                return v("titleRefreshInterval")
            },
            setTitleRefreshInterval: function(e) {
                y("titleRefreshInterval", Math.max(parseInt(e), 0))
            },
            getBrowserNotification: function() {
                return v("browserNotification")
            },
            ...
            setRpcHost: function(e) {
                y("rpcHost", e)
            },
            setRpcPort: function(e) {
                y("rpcPort", Math.max(parseInt(e), 0))
            },
            ...
            isUseWebSocket: function(e) {
                return e || (e = this.getProtocol()),
                "ws" === e || "wss" === e
            },
            getSecret: function() {
                var e = v("secret");
            ...
            getGlobalStatRefreshInterval: function() {
                return v("globalStatRefreshInterval")
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLogService", ["$log", "ariaNgSettingService",
    function(e, t) {
        return {
            debug: function(a, n) {
                t.isEnableDebugMode() && e.debug("[AriaNg Debug]" + a, n)
            },
            info: function(t, a) {
                e.info("[AriaNg Info]" + t, a)
            },
            warn: function(t, a) {
                e.warn("[AriaNg Warn]" + t, a)
            },
            error: function(t, a) {
                e.error("[AriaNg Error]" + t, a)
            }
        }
    }])
} (),
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2HttpRpcService", ["$http", "ariaNgSettingService", "ariaNgLogService",
    function(e, t, a) {
        var n = t.getJsonRpcUrl();
        return {
            request: function(t) {
                if (t) {
                    var i = {
                    ...
                    return a.debug("Http Request Start", i),
                    e(i).success(function(e) {
                        a.debug("Http Response Success", e),
                        e && t.successCallback && t.successCallback(e.id, e.result)
                    }).error(function(e) {
                        a.debug("Http Response Error", e),
                        e || (e = {
                            id: "-1",
                            error: {
                                innerError: !0
                        ...
                        t.errorCallback && t.errorCallback(e.id, e.error)
                    })
                }
            },
            on: function(e, t) {}
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2WebSocketRpcService", ["$q", "$websocket", "ariaNgSettingService", "ariaNgLogService",
    function(e, t, a, n) {
        var i = a.getJsonRpcUrl(),
        s = null,
        o = {},
        r = {},
        l = function(e) {
            ...
            if (t) {
                ...
                if (a) {
                    ...
                    e.result && i.successCallback && (n.debug("WebSocket Response Success", e), i.successCallback(i.id, e.result)),
                    e.error && i.errorCallback && (n.debug("WebSocket Response Error", e), i.errorCallback(i.id, e.error)),
                    delete o[t]
                }
            }
        },
        c = function(e) {
            ...
            if (t) {
                var a = r[t];
                if (angular.isArray(a) && !(a.length < 1)) for (var n = 0; n < a.length; n++) {
                    var i = a[n],
        ...
        return {
            request: function(t) {
                if (t) {
                    ...
                    n.debug("WebSocket Request Start", t);
                    var r = e.defer();
                    return o[i] = {
                        context: t,
                        deferred: r
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2RpcService", ["$q", "aria2RpcConstants", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "aria2HttpRpcService", "aria2WebSocketRpcService",
    function(e, t, a, n, i, s, o) {
        var r = i.isUseWebSocket() ? o: s,
        l = !1,
        c = i.getSecret(),
        d = [],
        u = [],
        ...
        k = function(e, t) {
            ...
            r.on(a,
            function(e) {
                if (angular.isArray(t) && !(t.length < 1)) for (var a = 0; a < t.length; a++) {
                    var n = t[a];
                    n(e)
                }
            })
        ...
        T = function(t, a, n) {
            for (var i = [], s = !1, o = !1, r = [], l = 0; l < a.length; l++) a[l].callback = function(e) {
                r.push(e),
                s |= e.success,
                o |= !e.success
            },
        ...
        x = function(e) {
            return ! (!e || !e.message) && (a[e.message] && a[e.message].tipTextKey ? (n.showError(a[e.message].tipTextKey), !0) : (n.showError(e.message), !0))
        },
        P = function() {
            var e = arguments[0],
            a = v(e),
            ...
            if (c && !a && n.push(t.rpcTokenPrefix + c), arguments.length > 1) {
                var s = arguments[1];
            ...
            if (arguments.length > 2) for (var o = 2; o < arguments.length; o++) null !== arguments[o] && angular.isDefined(arguments[o]) && n.push(arguments[o]);
        ...
        return function() {
            ...
            k("onDownloadPause", p),
            k("onDownloadStop", f),
            k("onDownloadComplete", g),
            k("onDownloadError", m),
            k("onBtDownloadComplete", h)
        } (),
        {
            ...
            addUriMulti: function(e) {
                ...
                return T(this.addUri, t, e.callback)
            },
            addTorrent: function(e, t) {
                var a = e.task.content,
                n = angular.copy(e.task.options);
                return e.pauseOnAdded && (n.pause = "true"),
                w(P("addTorrent", e, a, [], n), !!t)
            },
            addMetalink: function(e, t) {
                var a = e.task.content,
                n = angular.copy(e.task.options);
                return e.pauseOnAdded && (n.pause = "true"),
                w(P("addMetalink", e, a, [], n), !!t)
            },
            remove: function(e, t) {
                return w(P("remove", e, e.gid), !!t)
            },
            forceRemove: function(e, t) {
                return w(P("forceRemove", e, e.gid), !!t)
            },
            forceRemoveMulti: function(e) {
                for (var t = [], a = 0; a < e.gids.length; a++) t.push({
                    silent: !!e.silent,
                    gid: e.gids[a]
                });
                return T(this.forceRemove, t, e.callback)
            },
            pause: function(e, t) {
                return w(P("pause", e, e.gid), !!t)
            },
            pauseAll: function(e, t) {
                return w(P("pauseAll", e), !!t)
            },
            forcePause: function(e, t) {
                return w(P("forcePause", e, e.gid), !!t)
            },
            forcePauseMulti: function(e) {
                ...
                return T(this.forcePause, t, e.callback)
            },
            forcePauseAll: function(e, t) {
                return w(P("forcePauseAll", e), !!t)
            },
            unpause: function(e, t) {
                return w(P("unpause", e, e.gid), !!t)
            },
            unpauseMulti: function(e) {
                ...
                return T(this.unpause, t, e.callback)
            },
            unpauseAll: function(e, t) {
                return w(P("unpauseAll", e), !!t)
            },
            tellStatus: function(e, t) {
                return w(P("tellStatus", e, e.gid), !!t)
            },
            getUris: function(e, t) {
                return w(P("getUris", e, e.gid), !!t)
            },
            getFiles: function(e, t) {
                return w(P("getFiles", e, e.gid), !!t)
            },
            getPeers: function(e, t) {
                return w(P("getPeers", e, e.gid), !!t)
            },
            getServers: function(e, t) {
                return w(P("getServers", e, e.gid), !!t)
            },
            tellActive: function(e, t) {
                return w(P("tellActive", e, angular.isDefined(e.requestParams) ? e.requestParams: null), !!t)
            },
            tellWaiting: function(e, t) {
                return w(P("tellWaiting", e, angular.isDefined(e.offset) ? e.offset: 0, angular.isDefined(e.num) ? e.num: 1e3, angular.isDefined(e.requestParams) ? e.requestParams: null), !!t)
            },
            tellStopped: function(e, t) {
                return w(P("tellStopped", e, angular.isDefined(e.offset) ? e.offset: 0, angular.isDefined(e.num) ? e.num: 1e3, angular.isDefined(e.requestParams) ? e.requestParams: null), !!t)
            },
            changePosition: function(e, t) {
                return w(P("changePosition", e, e.gid, e.pos, e.how), !!t)
            },
            changeUri: function(e, t) {
                return w(P("changeUri", e, e.gid, e.fileIndex, e.delUris, e.addUris), !!t)
            },
            getOption: function(e, t) {
                return w(P("getOption", e, e.gid), !!t)
            },
            changeOption: function(e, t) {
                return w(P("changeOption", e, e.gid, e.options), !!t)
            },
            getGlobalOption: function(e, t) {
                return w(P("getGlobalOption", e), !!t)
            },
            changeGlobalOption: function(e, t) {
                return w(P("changeGlobalOption", e, e.options), !!t)
            },
            getGlobalStat: function(e, t) {
                return w(P("getGlobalStat", e), !!t)
            },
            purgeDownloadResult: function(e, t) {
                return w(P("purgeDownloadResult", e), !!t)
            },
            removeDownloadResult: function(e, t) {
                return w(P("removeDownloadResult", e, e.gid), !!t)
            },
            removeDownloadResultMulti: function(e) {
                ...
                return T(this.removeDownloadResult, t, e.callback)
            },
            getVersion: function(e, t) {
                return w(P("getVersion", e), !!t)
            },
            getSessionInfo: function(e, t) {
                return w(P("getSessionInfo", e), !!t)
            },
            shutdown: function(e, t) {
                return w(P("shutdown", e), !!t)
            },
            forceShutdown: function(e, t) {
                return w(P("forceShutdown", e), !!t)
            },
            saveSession: function(e, t) {
                return w(P("saveSession", e), !!t)
            },
            multicall: function(e) {
                return w(P("system.multicall", e, e.methods))
            },
            listMethods: function(e) {
                return w(P("system.listMethods", e))
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2TaskService", ["$q", "$translate", "bittorrentPeeridService", "aria2Errors", "aria2RpcService", "ariaNgCommonService",
    function(e, t, a, n, i, s) {
        var o = function(e) {
            if (!e) return "";
            var t = e.path; ! t && e.uris && e.uris.length > 0 && (t = e.uris[0].uri);
            var a = t.lastIndexOf("/");
        ...
        l = function(e) {
            ...
            !a && e.files && e.files.length > 0 && (a = o(e.files[0])),
        ...
        d = function(e, t) {
            ...
            if (!e) return a;
            for (var i = 0,
            n = 0; n < e.length; n++) for (var s = parseInt(e[n], 16), o = 1; o <= 4; o++) {
                var r = 1 << 4 - o,
                l = (s & r) === r;
                if (a[i++] = l, i >= t) return a
            }
            return a
        },
        u = function(e, t) {
        ...
        p = function(e) {
            if (!e) return e;
            var t = d(e.bitfield, e.numPieces);
            ...
            e.remainTime = r(e.remainLength, e.downloadSpeed),
            e.seeder = e.seeder === !0 || "true" === e.seeder;
            var a = l(e);
            if (e.taskName = a.name, e.hasTaskName = a.success, e.errorDescription = c(e), e.files) {
                for (var n = 0,
                i = 0; i < e.files.length; i++) {
                    var u = e.files[i];
                    u.fileName = o(u),
                    u.length = parseInt(u.length),
                    u.selected = u.selected === !0 || "true" === u.selected,
                    u.completedLength = parseInt(u.completedLength),
                    u.completePercent = u.length > 0 ? u.completedLength / u.length * 100 : 0,
                    n += u.selected ? 1 : 0
                }
        ...
        f = function(e, t, n) {
            if (!e) return e;
            for (var i = d(t.bitfield, t.numPieces), o = s.countArray(i, !0), r = t.completePercent, l = 0; l < e.length; l++) {
                var c = e[l],
                u = c.uploadSpeed,
                p = c.downloadSpeed,
                f = d(c.bitfield, t.numPieces),
                g = s.countArray(f, !0);
                if (c.name = c.ip + ":" + c.port, c.completePercent = g / t.numPieces * 100, c.downloadSpeed = u, c.uploadSpeed = p, c.seeder = c.seeder === !0 || "true" === c.seeder, g === o && c.completePercent !== r && (c.completePercent = r), c.peerId) {
                    var h = s.decodePercentEncodedString(c.peerId),
                    v = h ? a.parseClient(h) : null;
                    if (v && "unknown" !== v.client) {
                        var y = {
                            name: v.client ? v.client.trim() : "",
                            version: v.version ? v.version.trim() : ""
                        };
        ...
        return {
            getTaskList: function(e, t, a, n) {
                var s = null;
                if ("downloading" === e) s = i.tellActive;
                else if ("waiting" === e) s = i.tellWaiting;
                else {
                    if ("stopped" !== e) return;
                    s = i.tellStopped
                }
            ...
            getTaskStatusAndBtPeers: function(e, t, a, n, s) {
                ...
                i.multicall({
                    ...
                    callback: function(e) {
                        t && (e.task = {},
                        e.success && e.data.length > 0 && (e.task = e.data[0][0], p(e.task)), e.success && e.task.bittorrent && e.data.length > 1 && (e.peers = e.data[1][0], f(e.peers, e.task, s)), t(e))
                    }
                })
            },
            ...
            removeTasks: function(t, a, n) {
                for (var o = [], r = [], l = 0; l < t.length; l++)"complete" === t[l].status || "error" === t[l].status || "removed" === t[l].status ? r.push(t[l].gid) : o.push(t[l].gid);
                var c = [],
                d = !1,
                u = !1,
                p = [];
            ...
            onTaskCompleted: function(e) {
                e && i.onDownloadComplete({
                    callback: g(this.getTaskStatus, e, "completed")
                })
            },
            onBtTaskCompleted: function(e) {
                e && i.onBtDownloadComplete({
                    callback: g(this.getTaskStatus, e, "btcompleted")
                })
            },
            onTaskErrorOccur: function(e) {
                e && i.onDownloadError({
                    callback: g(this.getTaskStatus, e, "error")
                })
            },
            processDownloadTasks: function(e) {
                if (angular.isArray(e)) for (var t = 0; t < e.length; t++) p(e[t])
            },
            ...
            estimateHealthPercentFromPeers: function(e, t) {
                if (!e || e.numPieces < 1 || t.length < 1) return e.completePercent;
                for (var a = [], n = 0, i = e.completePercent, s = 0; s < e.numPieces; s++) a.push(0);
                for (var s = 0; s < t.length; s++) {
                    for (var o = t[s], r = d(o.bitfield, e.numPieces), l = 0, c = 0; c < r.length; c++) {
                        var u = r[c] ? 1 : 0;
                        a[c] += u,
                        l += u
                    }
                    l > n ? (n = l, i = o.completePercent) : l === n && o.completePercent > i && (i = o.completePercent)
                }
                var p = 0;
                if (a.length > 0) for (;;) {
                    for (var f = !0,
                    s = 0; s < a.length; s++) a[s] > 0 ? (p++, a[s]--) : f = !1;
                    if (!f) break
                }
                if (p <= n) return i;
                var g = p / e.numPieces * 100;
                return g <= i ? i: g
            }
        }
    }])
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2SettingService", ["aria2AllOptions", "aria2GlobalAvailableOptions", "aria2TaskAvailableOptions", "ariaNgCommonService", "aria2RpcService",
    function(e, t, a, n, i) {
        var s = function(e) {
            if (!e) return e;
        ...
        return {
            ...
            getAvailableTaskOptionKeys: function(e, t) {
                for (var n = a.taskOptions,
                i = [], s = 0; s < n.length; s++) {
                    var o = n[s],
                    r = {
                        key: o.key
                    };
                    o.newOnly || o.httpOnly && t || o.btOnly && !t || (o.activeReadonly && "active" === e && (r.readonly = !0), i.push(r))
                }
                return i
            },
            getNewTaskOptionKeys: function(e) {
                for (var t = a.taskOptions,
                n = [], i = 0; i < t.length; i++) {
                    var s = t[i],
                    o = {
                        key: s.key
            ...
            getSpecifiedOptions: function(t) {
                for (var a = [], n = 0; n < t.length; n++) {
                    ...
                    if (r) {
                        ...
                        r), "boolean" === r.type && (r.options = ["true", "false"]), s && (r.readonly = !0), r.options) {
                            for (var l = [], c = 0; c < r.options.length; c++) l.push({
                                name: "options." + r.options[c],
                                value: r.options[c]
                            });
                            r.options = l
                        }
